...
<form>
  ...
  <select id="form-options">
    ...
    <option value="Investment Opportunity">Investment Opportunities</option>
  </select>
  <textarea name="message" placeholder="Your message" style="width:200px; height:200px;"></textarea>
